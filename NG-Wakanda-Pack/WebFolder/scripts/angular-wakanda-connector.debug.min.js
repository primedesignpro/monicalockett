/*! angular-wakanda-connector - v0.0.11 - 2014-04-18 */
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", "$http", function($q, $rootScope, $http) {
        ...
        var transform = {
            ...
            addFrameworkMethodsToNestedCollection: function(result) {
                ...
                result.$totalCount = function() {
                    console.error("$totalCount not yet implemented on nested collections");
                };
            }
        };
        var $$create = function(pojo) {
            var dataClassName = this._private.className, ngWakEntity;
        ...
        var $fetchOnNestedDeferredCollection = function() {
            ...
            if ("undefined" === typeof that.$_deferred) {
                ...
                that.length = 0;
                if (result.length > 0) for (i = 0; i < result.length; i++) that.push(result[i]);
